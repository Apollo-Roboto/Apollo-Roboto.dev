...
I wrote my own little wrapper around Cloudflare's REST API. I didn't had many endpoint to interface with so that wasn't too difficult to implement. This project was an opportunity to learn more about client mocking in unit tests with [httpmock](https://crates.io/crates/httpmock).
